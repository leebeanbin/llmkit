...
class BufferMemory(BaseMemory):
    ...
    Example:
        ```python
        from llmkit.domain.memory import BufferMemory
...
class WindowMemory(BaseMemory):
    ...
    Example:
        ```python
        from llmkit.domain.memory import WindowMemory
...
class TokenMemory(BaseMemory):
    ...
    Example:
        ```python
        from llmkit.domain.memory import TokenMemory
...
class SummaryMemory(BaseMemory):
    ...
    Example:
        ...
        from llmkit.domain.memory import SummaryMemory
...
class ConversationMemory(BaseMemory):
    ...
    Example:
        ```python
        from llmkit.domain.memory import ConversationMemory
