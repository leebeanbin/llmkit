...
def cosine_similarity(vec1: List[float], vec2: List[float]) -> float:
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import embed_sync, cosine_similarity
...
def euclidean_distance(vec1: List[float], vec2: List[float]) -> float:
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import embed_sync, euclidean_distance
...
def normalize_vector(vec: List[float]) -> List[float]:
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import embed_sync, normalize_vector
...
def batch_cosine_similarity(
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import embed_sync, batch_cosine_similarity
